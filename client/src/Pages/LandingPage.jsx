  ...
  const testimonials = [
    {
      ...
      content: "Invetora has transformed my shopping experience. The quality and service are unmatched!",
      rating: 5
    },
    {
      name: "Michael Chen",
    ...
    <div style={styles.body}>
      ...
      <nav style={styles.nav}>
        ...
        <div style={styles.mobileMenu}>
          <a href="#home" style={{ ...styles.navLink, display: 'block', padding: '0.5rem 0' }}>Home</a>
          <a href="#products" style={{ ...styles.navLink, display: 'block', padding: '0.5rem 0' }}>Products</a>
          <a href="#about" style={{ ...styles.navLink, display: 'block', padding: '0.5rem 0' }}>About</a>
          <a href="#contact" style={{ ...styles.navLink, display: 'block', padding: '0.5rem 0' }}>Contact</a>
        </div>
      </nav>
      ...
      <section id="home" style={styles.hero}>
        ...
        <div style={styles.heroContent}>
          ...
          <p style={styles.heroSubtitle}>
            ...
            Your gateway to exclusive shopping experiences.
          </p>
      ...
      <footer style={styles.footer}>
        <div style={styles.footerContent}>
          ...
          <div style={styles.copyright}>
            © 2025 Invetora. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
